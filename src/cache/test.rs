...
cfg_async! {
    mod async_test {
        use super::*;
        use crate::{
            AsyncCache, AsyncCacheBuilder, CacheCallback, Coster, DefaultCacheCallback, DefaultCoster, DefaultKeyBuilder,
            DefaultUpdateValidator, KeyBuilder, TransparentKeyBuilder, UpdateValidator,
        };
        use parking_lot::Mutex;
        use rand::rngs::OsRng;
        use rand::Rng;
        ...
        async fn test_cache_builder() {
            let _: AsyncCache<u64, u64, DefaultKeyBuilder> = AsyncCacheBuilder::new(100, 10, TransparentKeyBuilder::default())
            .set_coster(DefaultCoster::default())
            .set_update_validator(DefaultUpdateValidator::default())
            .set_callback(DefaultCacheCallback::default())
            .set_num_counters(200)
        ...
        async fn test_cache_key_to_hash() {
            ...
            let c: AsyncCache<u64, u64, KHTest> = AsyncCache::new(10, 1000, KHTest { ctr: ctr.clone() }).unwrap();
